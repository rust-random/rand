...
use rand_core::{RngCore, BlockRngCore, CryptoRng, SeedableRng, Error, ErrorKind, Void};
      ...
      Rsdr: RngCore
{
    ...
    type Error = Void;  // TODO: use rand_core::Error instead
    ...
    fn generate(&mut self, results: &mut Self::Results) -> Result<(), Void> {
        ...
        self.inner.generate(results).unwrap_or_else(|err|
                panic!("ReseedingRng: error generating results: {}", err));
