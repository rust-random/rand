      ...
      Rsdr: RngCore
{
    ...
    pub fn reseed(&mut self) -> Result<(), <Rsdr as RngCore>::Error> {
        self.0.core.reseed()
    }
}
      ...
      Rsdr: RngCore
{
    ...
    fn generate(&mut self, results: &mut Self::Results) -> Result<(), Self::Error> {
...
{
    /// Reseed the internal PRNG.
    fn reseed(&mut self) -> Result<(), <Rsdr as RngCore>::Error> {
    ...
    fn reseed_and_generate(&mut self,
                           ...
                           -> Result<(), <R as BlockRngCore>::Error>
    {
