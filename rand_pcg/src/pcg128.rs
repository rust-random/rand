...
/// A PCG random number generator (DXSM 128/64 (LCG) variant).
///
/// Permuted Congruential Generator with 128-bit state, internal Linear
...
/// output function. This corresponds to `pcg_engines::setseq_dxsm_128_64`
/// from pcg_cpp.
///
/// Despite the name, this implementation uses 32 bytes (256 bit) space
/// comprising 128 bits of state and 128 bits stream selector. These are both
...
#[derive(Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde1", derive(Serialize, Deserialize))]
pub struct Lcg128Dxsm64 {
    state: u128,
    increment: u128,
}

macro_rules! impl_lcg128 {
    ($ty:ty, $out:ident, $corr:literal) => {
        impl $ty {
            ...
            #[doc = "- `stream = 0xa02bdbf7bb3c0a7ac28fa16a64abf96`"]
...
fn output_dxsm(state: u128) -> u64 {
    ...
    const MULTIPLY: u64 = 15750249268501108917;
